    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light">
      <div class="container">
        <div class="navbar-brand">
          <img class="mb-3" src="/a_logo.png" alt="Aschehoug.js" width="100" />
        </div>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <router-link to="/" class="nav-link">Aschehoug Info</router-link>
            </li>
          </ul>
          <ul class="navbar-nav d-none d-md-block">
            ...
            <li class="nav-item dropdown" v-if="isAuthenticated">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                ...
                <router-link to="/video" class="dropdown-item dropdown-profile">
                  <font-awesome-icon class="mr-3" icon="photo-video" />Video
                </router-link>
          ...
          >
            ...
            <li>
              <font-awesome-icon icon="photo-video" class="mr-3" />
